...
app.post('/join', function(req, res) {
	...
	if (username != '' && roomname != '') {
		res.render('room', {username: username, roomname: roomname});	 //passer variable local pou le view
...
//plus
 ...
 //declancher  l'objet io en le relier au serveur express.
...
app.use(express.static(__dirname+'/listconncted3000/static'));
var userlist = {};
var liveVideoCalls = {};
...
// app.get('/gh', function(req, res) {
 // if (req.isAuthenticated())
// {res.sendFile(__dirname+'/listconncted3000/static/acc.html');}
// else 
...
{res.sendFile(__dirname+'/listconncted3000/static/acc.html');}
 ...
 res.sendFile(__dirname+'/acc2.html');
